/**
 * Placeholder for the Apple Deals dashboard.
...
export const metadata = { title: "Apple – Nimbridge" };

export default async function AppleDealsPage() {
  ...
  return (
    <div className="min-h-screen bg-neutral-950">
      <AppHeader
        brand="🔭 Nimbridge"
        links={buildNavLinks({ pathname: "/dashboard/apple", showAdmin: showAdminLink })}
        email={user.email ?? ""}
      ...
      <main className="mx-auto max-w-3xl px-4 py-20 text-center">
        ...
        <h1 className="text-3xl font-semibold text-white mb-3">Apple — Coming soon</h1>
        <p className="text-neutral-400 text-sm leading-relaxed">
          The crawler isn&apos;t configured to pick up Apple lots from Catawiki yet.
