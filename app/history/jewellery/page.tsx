/**
 * Placeholder for the Jewellery history page.
  ...
  return (
    <div className="min-h-screen bg-neutral-950">
      ...
      <main className="mx-auto max-w-3xl px-4 py-20 text-center">
        ...
        <h1 className="text-3xl font-semibold text-white mb-3">Jewellery history — Coming soon</h1>
        <p className="text-neutral-400 text-sm leading-relaxed">
          Closed-auction archive for Jewellery will appear here once the crawler is
