/**
 * Placeholder for the Apple history page.
...
export const metadata = { title: "Apple History – Nimbridge" };

export default async function AppleHistoryPage() {
  ...
  return (
    <div className="min-h-screen bg-neutral-950">
      <AppHeader
        brand="🔭 Nimbridge"
        links={buildNavLinks({ pathname: "/history/apple", showAdmin: showAdminLink })}
        email={user.email ?? ""}
      ...
      <main className="mx-auto max-w-3xl px-4 py-20 text-center">
        ...
        <h1 className="text-3xl font-semibold text-white mb-3">Apple history — Coming soon</h1>
        <p className="text-neutral-400 text-sm leading-relaxed">
          Closed-auction archive for Apple will appear here once the crawler is
